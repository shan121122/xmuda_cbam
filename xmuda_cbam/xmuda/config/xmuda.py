...
_C.TRAIN.XMUDA.lambda_fusion = 0.0
...
# ---------------------------------------------------------------------------- #
# CBAM Attention Module options
# ---------------------------------------------------------------------------- #
_C.CBAM = CN()
_C.CBAM.REDUCTION_RATIO = 16
_C.CBAM.KERNEL_SIZE = 7
_C.CBAM.FUSION_OUT_CHANNELS = 64
_C.CBAM.LOSS_WEIGHT = 0.2
