...
def preprocess(nusc, split_names, root_dir, out_dir,
    ...
    for i, sample in enumerate(nusc.sample):
        ...
        data_dict = {
            ...
            # 'points': sparse_tensor,
            # 'seg_labels': torch.sparse_coo_tensor(indices, torch.tensor(seg_labels, dtype=torch.int64), (num_pts,)),
...
if __name__ == '__main__':
    root_dir = '/work/sdim-lemons/fwzh/work/xmuda/xmuda/datasets_master/nuscenes'
    out_dir = '/work/sdim-lemons/fwzh/work/xmuda/xmuda/datasets_local/datasets_mjaritz/nuscenes_preprocess'
